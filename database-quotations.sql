...
INSERT INTO `quotation_items` (
  `quotation_id`, `material_code`, `material_name`,
  `length`, `width`, `thickness`, `quantity`, `unit`,
  `unit_price`, `remark`,
  `created_by`, `updated_by`, `is_deleted`
) VALUES 
(
  @quotation1_id, 'MT-BOPP-001', 'BOPP薄膜',
  1000, 500, 50.000000, 20, '卷',
  50.00, '常规产品',
  'admin', 'admin', 0
),
(
  @quotation1_id, 'MT-PET-002', 'PET薄膜',
...
(
  @quotation2_id, 'MT-CPP-003', 'CPP薄膜',
  1500, 800, 60.000000, 30, '卷',
  55.00, '批量订单',
  'admin', 'admin', 0
),
(
  @quotation2_id, 'MT-BOPET-004', 'BOPET薄膜',
  1000, 600, 12.000000, 40, '卷',
  70.00, '特殊规格',
  'admin', 'admin', 0
),
(
  @quotation2_id, 'MT-ALU-005', '铝箔',
