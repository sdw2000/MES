...
-- 初始化设备类型
INSERT INTO `equipment_type` (`type_code`, `type_name`, `process_order`, `description`, `status`) VALUES
...
('SHOP003', '第三号车间', '王五', '生产区C', 1);

-- 验证数据
SELECT * FROM `equipment_type` WHERE `status` = 1 ORDER BY `process_order`;
